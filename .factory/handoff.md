...
- Production-bundle Lighthouse mobile: Performance **100**, Accessibility **100**, Best Practices **96**, SEO **92**; LCP **1.4 s**, CLS **0.017**, total blocking time **0 ms**.
- Initial bundle sizes, uncompressed: landing JS **3.48 KB**, landing CSS **10.68 KB**, app JS **20.43 KB total**, app CSS **12.88 KB**. No font payload.
...
- Asset/checksum verification: pending the tagged GitHub Actions run; update this section after the release job completes.
